...
const WelcomeBanner = () => (<div className="bg-gradient-to-r from-green-600 via-green-500 to-blue-600 p-6 rounded-xl shadow"><h2 className="text-3xl font-bold mb-2">ยินดีต้อนรับ!</h2><p className="text-lg opacity-90">สั่งยาตามโรคของคุณได้ง่ายๆ ที่นี่ (ควรทานตามคำแนะนำของแพทย์)</p></div>);
